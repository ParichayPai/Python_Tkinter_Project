...
class MyProject:
    def __init__(self,master):
        ...
        self.label4=Label(self.tf,text='''Ove Road, Sector 35-D, Kharghar, Navi Mumbai ''',font=('Courier', 12),bg='orange',anchor=W)
        ...
        self.l6=Label(self.tf,text="Contact No\n9769038259",font=('Courier', 12),bg='orange',justify=LEFT)
...
class PlaceOrder():
    def __init__(self,master,logo):
        ...
        self.v1=IntVar()
        self.c1=Checkbutton(self.lf,text="Veg Kolhapuri",font=('Courier', 11, 'bold'), bg='orange',variable=self.v1)
